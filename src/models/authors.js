...
const authorScehma = new mongoose.Schema({
    ...
    password:{
        ...
        validate(value){
            ...
            if(!reg.test(value)){
                throw new Error('Password invalid ,password must consist of 9 numbers ,uppercase ,lowercase ,special charcater')
            }
        }
    },
    mobile:{
        ...
        validate(value){
            ...
            if (!phoneRegex.test(value)) {
                throw new Error('Number invalid ,Please use EGY number')
            }
        }
    },
    avatar: {
